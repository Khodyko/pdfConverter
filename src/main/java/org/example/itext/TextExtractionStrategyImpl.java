...
public class TextExtractionStrategyImpl implements TextExtractionStrategy {
    ...
    public ArrayList<Pair<Float, String>> getStringsWithCoordinates() {
        ...
        for (Map.Entry<Float, TreeMap<Float, String>> stringMap: textMap.entrySet()) {
            ...
            //fixme mutable or immutable?
            result.add(new MutablePair <Float, String>(stringMap.getKey(), stringBuilder.toString()));
        }
